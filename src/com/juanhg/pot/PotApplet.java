...
public class PotApplet extends JApplet implements Runnable {
	...
	int chartsSupYLimit = 10;
	int chartsInfYLimit = 0;

	//Images
	BufferedImage exampleImage, fire1Image, fire2Image, displayImage;
...
//		initDisplay();
	...
	void updateOutputs(){
		...
		WAnnotation = chartChart.drawBox(0.5, 0, 1.5, model.getW(),stroke, Color.BLACK, Color.RED);
		chartChart.deleteAnnotation(QAnnotation);
		QAnnotation = chartChart.drawBox(2.5, 0, 3.5, model.getW(),stroke, Color.BLACK, Color.ORANGE);
		chartChart.deleteAnnotation(TAnnotation);
		TAnnotation = chartChart.drawBox(4.5, 0, 5.5, model.getW(),stroke, Color.BLACK, Color.YELLOW);
		chartChart.deleteAnnotation(UAnnotation);
		UAnnotation = chartChart.drawBox(6.5, 0, 7.5, model.getW(),stroke, Color.BLACK, Color.GREEN);
		chartChart.deleteAnnotation(PAnnotation);
		PAnnotation = chartChart.drawBox(8.5, 0, 9.5, model.getW(),stroke, Color.BLACK, Color.BLUE);
		chartChart.deleteAnnotation(VAnnotation);
		VAnnotation = chartChart.drawBox(10.5, 0, 11.5, model.getW(),stroke, Color.BLACK, Color.MAGENTA);
	}
