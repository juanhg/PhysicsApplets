...
public class IceWalkerApplet extends JApplet implements Runnable {
    ...
    private JLabel lblStaticFrictionValue, lblDynamicValue, lblStregthValue;
	...
	void sliderDynamicFrictionEvent(){
		...
		if(sliderDynamicFriction.getValueIsAdjusting()){
			lblDynamicValue.setText(Double.toString((double)sliderDynamicFriction.getValue()/1000.0));
		}
	}
	...
	void sliderStaticFrictionEvent(){
		...
		if(sliderStaticFriction.getValueIsAdjusting()){
			lblStaticFrictionValue.setText(Double.toString((double)sliderStaticFriction.getValue()/1000.0));
			sliderDynamicFriction.setMinimum((int)(sliderStaticFriction.getValue()*0.3));
		}
	}
	...
	private void readInputs(){
		...
		this.mu = ((double)this.sliderStaticFriction.getValue())/1000.0;
		this.mud = ((double)this.sliderDynamicFriction.getValue())/1000.0;
	}
...
//		grafica.agregarGrafica(model.getTrajectoryAsArray(), "Trayectoria", Color.RED, 1f,false);
	...
	private void autogeneratedCode(){
		...
		lblStaticFrictionValue = new JLabel("0.1");
		lblStaticFrictionValue.setFont(new Font("Tahoma", Font.PLAIN, 14));
		
		lblDynamicValue = new JLabel("0.03");
		lblDynamicValue.setFont(new Font("Tahoma", Font.PLAIN, 14));
		...
		sliderStaticFriction.setMinimum(10);
		sliderStaticFriction.setMaximum(300);
		sliderStaticFriction.setMinorTickSpacing(10);
		sliderStaticFriction.setValue(100);
		...
		sliderDynamicFriction.setValue(30);
		sliderDynamicFriction.setMaximum(70);
		sliderDynamicFriction.setMinimum(30);
		sliderDynamicFriction.addChangeListener(new ChangeListener() {
			public void stateChanged(ChangeEvent e) {
				sliderDynamicFrictionEvent();
			}
		});
		sliderDynamicFriction.setMinorTickSpacing(10);
			...
			gl_panelInputs.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_panelInputs.createSequentialGroup()
					...
					.addGroup(gl_panelInputs.createParallelGroup(Alignment.LEADING)
						...
						.addComponent(lblDynamicValue, GroupLayout.PREFERRED_SIZE, 56, GroupLayout.PREFERRED_SIZE))
					.addGap(18)
					.addGroup(gl_panelInputs.createParallelGroup(Alignment.LEADING)
			...
			gl_panelInputs.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelInputs.createSequentialGroup()
					...
					.addGroup(gl_panelInputs.createParallelGroup(Alignment.LEADING)
						...
						.addComponent(lblDynamicValue, GroupLayout.PREFERRED_SIZE, 17, GroupLayout.PREFERRED_SIZE)
