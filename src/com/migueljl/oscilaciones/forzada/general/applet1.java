...
public class applet1 extends javax.swing.JApplet implements Runnable {
    ...
    private void initComponents() {
        ...
        F0_etiq = new javax.swing.JLabel();
        F0_input = new javax.swing.JTextField();
        ...
        escala_tiempo_etiq = new javax.swing.JLabel();
        escala_tiempo_input = new javax.swing.JTextField();
        bcambiarescala2 = new javax.swing.JButton();
        ...
        F0_etiq.setText("Amplitud  F impulsora (F0)");

        F0_input.setText("100");
        ...
        panel_inputLayout.setHorizontalGroup(
            ...
            .addGroup(panel_inputLayout.createSequentialGroup()
                ...
                .addGroup(panel_inputLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panel_inputLayout.createSequentialGroup()
                        .addGroup(panel_inputLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(F0_etiq, javax.swing.GroupLayout.PREFERRED_SIZE, 194, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(F0_input, javax.swing.GroupLayout.PREFERRED_SIZE, 167, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(0, 0, Short.MAX_VALUE))
                    .addGroup(panel_inputLayout.createSequentialGroup()
                        .addGroup(panel_inputLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(w_etiq, javax.swing.GroupLayout.DEFAULT_SIZE, 288, Short.MAX_VALUE)
                            .addGroup(panel_inputLayout.createSequentialGroup()
                                .addGroup(panel_inputLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(m_etiq)
                                    .addComponent(k_input, javax.swing.GroupLayout.DEFAULT_SIZE, 168, Short.MAX_VALUE)
                                    .addComponent(m_input)
                                    .addComponent(w_input)
                                    .addComponent(k_etiq)
                                    .addComponent(x0_input)
                                    .addComponent(v0_input))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(visualizar_fuerza, javax.swing.GroupLayout.PREFERRED_SIZE, 96, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addContainerGap())))
        );
        panel_inputLayout.setVerticalGroup(
            ...
            .addGroup(panel_inputLayout.createSequentialGroup()
                ...
                .addComponent(F0_etiq)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(F0_input, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(k_etiq, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        escala_tiempo_etiq.setText("Escala de tiempo:");

        escala_tiempo_input.setText("60");

        bcambiarescala2.setText("CAMBIAR");
        bcambiarescala2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bcambiarescala2ActionPerformed(evt);
            }
        });
        ...
        panel_botonesLayout.setHorizontalGroup(
            ...
            .addGroup(panel_botonesLayout.createSequentialGroup()
                ...
                .addGroup(panel_botonesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panel_botonesLayout.createSequentialGroup()
                        .addComponent(bsimular, javax.swing.GroupLayout.DEFAULT_SIZE, 158, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(bpausa_continua))
                    .addGroup(panel_botonesLayout.createSequentialGroup()
                        .addGroup(panel_botonesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(escala_etiq)
                            .addComponent(escala_tiempo_etiq))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(panel_botonesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(escala_input, javax.swing.GroupLayout.DEFAULT_SIZE, 42, Short.MAX_VALUE)
                            .addComponent(escala_tiempo_input))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGroup(panel_botonesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(bcambiarescala)
                            .addComponent(bcambiarescala2))))
                .addContainerGap())
        );
        panel_botonesLayout.setVerticalGroup(
            ...
            .addGroup(panel_botonesLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(panel_botonesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(bsimular, javax.swing.GroupLayout.DEFAULT_SIZE, 74, Short.MAX_VALUE)
                ...
                .addGroup(panel_botonesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(escala_tiempo_etiq)
                    .addComponent(escala_tiempo_input, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(bcambiarescala2))
                .addGap(18, 18, 18)
                .addGroup(panel_botonesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(escala_etiq)
    ...
    private void bsimularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bsimularActionPerformed
       ...
       F0 = transformarDouble(F0_input.getText());

       Modelo modelo = new Modelo(w,F0,m,k,x0,v0);
    ...
    /**
     * Permite cambiar la escala temporal de la simulación.
     * @param evt Evento con la información del cambio
     */
    
    private void bcambiarescala2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bcambiarescala2ActionPerformed
        // TODO add your handling code here:
         TFIN = transformarDouble(escala_tiempo_input.getText());
       ...
       repaint();
        ...
        flujo = new Thread(this);
        flujo.start();
    }//GEN-LAST:event_bcambiarescala2ActionPerformed

    /**
     * Permite visualizar/ocultar la gráfica de la fuerza aplicada.
     * @param evt Evento con la información del cambio
     */
     ...
     */
      ...
      /**
       * Función que obtiene el conjunto de puntos que define la línea de referencia en las gráficas (línea horizonal en X = 0)
       * @return Un conjunto de puntos que representan la linea de referencia.
       */
      
    private Point2D[] getLineaReferencia() {
        Point2D[] linea = new Point2D[2];
        
        linea[0] = new Point2D.Double(0,0);
        linea[1] = new Point2D.Double(TFIN,0);
    ...
    private javax.swing.JLabel F0_etiq;
    private javax.swing.JTextField F0_input;
    private javax.swing.JButton bcambiarescala;
    private javax.swing.JButton bcambiarescala2;
    ...
    private javax.swing.JLabel escala_tiempo_etiq;
    private javax.swing.JTextField escala_tiempo_input;
    ...
    /**
     * Indica si se está visualizando la fuerza.
     */
    ...
    public void run() {
        ...
        while(!fin) {
            ...
            grafposicion.agregarGrafica(getLineaReferencia(), "referencia", Color.GRAY,1,true);
            ...
            if(visualizarf) {
                ...
                grafposicion.fijaRango(-F0,F0,2,1);
            }
            ...
            simulacion.fijaRango(-4.0,4.0,0,1);
